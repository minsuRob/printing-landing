...
const VIDEOS = [
  {
    ...
    src: 'https://assets.mixkit.co/videos/preview/mixkit-industrial-robotic-arm-in-action-34538-large.mp4',
    badge: '레이저 가공',
  },
  {
    id: 'video-002',
    ...
    src: 'https://assets.mixkit.co/videos/preview/mixkit-printing-machine-printing-press-23112-large.mp4',
    badge: '열전사 프린팅',
  },
  {
    id: 'video-005',
